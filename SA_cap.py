...
#              '6-19-18_powder.mdat',
              '6-21-18_ME.mdat',
              '7-23-18_ME_CV.mdat', # CV was messed up
              '7-27-18_ME_CV.mdat', # includes higher sweep rates
#              '6-25-18_ME_STIRRED.mdat',
#              '6-25-18_Powder_Stirred_2.mdat',
#              '6-7_Cyclical_MicroElec.mdat',
#              '6-7_Cyclical_bijel1_broken.mdat',
#              '6-19-18_Bijel.mdat', #30 micron
#              '6-28-18_bijel stirred.mdat',
#              '6-29-18_sm_Powder_stirred.mdat',
#              '7-9-18_sm_powder_sonication.mdat',
              #'7-16-18_P_powder_CV.mdat',
              #'7-13-18_AR_powder_CV.mdat',
              #'7-20_18_bijel_#1_CV.mdat', # 30 micron
              #'7-25_18_bijel#5_CV.mdat', # 60 micron
              #'7-26-18_planar_pellet_CV.mdat',
              #'7-26-18_planar_bijels_CV.zip',
              #'7-12-18_med_planar_CV.mdat',
              #'7-31-18_bijel#6_CV.zip', # 15 micron
              #'7-31-18_bijel#7_CV.zip', # 15 micron
              #'8-1-18_bijel#3_CV.zip', # 30 micron
              #'8-1-18_bijel#4_CV.zip', # 60 micron
              #'8-14-18_bijel#9_CV.zip', #30 micron
              #'8-14-18_bijel#10_CV.zip', #30 micron
              #'8-22-18_AR3_CV.mdat'
              #'10-6-18_bijel#11_CV.mdat',
              #'7-22-19_B15_CV.zip',
              #'7-22-19_PP_CV.zip'
              #'7-24-19_B15_CV.zip',
              #'7-24-19_B17_CV.zip',
              ...
              #'7-30-19_B16_CV.zip',
              #'7-31-19_B16_CV.mdat',
              '8-1-19_PAR_7mm_1_CV.zip',
              '8-1-19_PC_7mm_1_CV.zip',
              '8-1-19_PP_7mm_1_CV.zip',
              #'8-1-19_B13_CV.zip',
              #'8-9-19_PED_CV.zip',
              #'8-9-19_B14_CV.zip',
              #'8-21-19 powderC quarter inch cv.mdat',
              '8-29-19_B20_CV.mdat',
              '8-29-19_B18_CV.zip',
              '8-29-19_B22_CV.zip'
              ]
...
for file_name in file_names:
    ...
    if 'ME' in file_name:
        ...
        plotmin, plotmax = -0.4, 0.6   # Set the limits for the plot here
        ...
        plotmin, plotmax = -0.1, 0.6   # Set the limits for the plot here    
    elif 'planar' in file_name:
        cvmin, cvmax = 0.2, 0.6       # Set the limits for the duck curve here
        plotmin, plotmax = 0, 0.6   # Set the limits for the plot here    
...
#    plt.show()
    ...
    results2 = results2[np.where(results2[:,0] < 0)[0],:]
    string = file_name + ' Surface Area: %.3g +/- %.3g cm^2' % (np.mean(0.0019635 * results2[:4,-2] / results2[:4,2]),
                                                             np.std(0.0019635 * results2[:4,-2] / results2[:4,2]))
    plt.title(string, fontproperties=mdat.font)
    plt.savefig(mdat.tmpdir + file_name[:-5] + '_CV.svg', transparent=True, )
    plt.close()

n=2
for file_name in file_names:
    print(file_name + ' Surface Area: %.3g +/- %.3g cm^2' % (np.mean(0.0019635 * results2[:4,n] / results2[:4,2]),
                                                             np.std(0.0019635 * results2[:4,n] / results2[:4,2])))
    n = n+3
